...
(function () {
    ...
    stripeScript.onload = function () {
        ...
        function showPopup(localStorageData) {
            ...
            fetch('https://junecare-assurance.github.io/thoiry/thoiry_popup.html?v=' + new Date().getTime())
                ...
                .then(data => {
                    ...
                    document.getElementById('dateInput').value = localStorageData.startDate + ' - ' + localStorageData.endDate || 'Non trouvé';
    ...
    `;
        ...
        function addButton() {
            const intervalId = setInterval(() => {
                const existingButton = document.querySelector('.kr-payment-button');
                console.log("dfsfs");
                if (existingButton) {
