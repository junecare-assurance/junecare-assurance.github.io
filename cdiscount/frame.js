...
!function(c) {
    if ("undefined" != typeof window) {
        ...
        function() {
            ...
            return X = this,
            Y = arguments,
            t <= 0 || L < t ? (Q && (clearTimeout(Q),
            Q = null),
            G = e,
            K = V.apply(X, Y),
            Q || (X = Y = null)) : Q = Q || setTimeout(Ee, t),
            K
        }
        );
        te(window, "message", function(t) {
            var n = {
                ...
                reset: function() {
                    v ? ie("Page reset ignored by init") : (ie("Page size reset by host page"),
                    Me("resetPage"))
                },
                resize: function() {
    ...
    function ae() {
        ...
        function o(e, t) {
            ie("Add event listener: " + t),
            te(window.document, e, n)
        }
        t = y.substr(M).split(":"),
        I = t[0],
        ...
        function() {
            function e(e, t) {
                return "function" == typeof e && (ie("Setup custom " + t + "CalcMethod"),
                W[t] = e,
                e = "custom"),
                e
            }
        ...
        !0 === O && (o("mouseenter", "Mouse Enter"),
        o("mouseleave", "Mouse Leave")),
        he(),
        w = function() {
            function i(e) {
            ...
            function n(e) {
                var t, n = e.split("#")[1] || e, e = decodeURIComponent(n), o = document.getElementById(e) || document.getElementsByName(e)[0];
                c !== o ? (t = i(t = o),
                ie("Moving to in page link (#" + n + ") at x: " + t.x + " y: " + t.y),
                Ne(t.y, t.x, "scrollToOffset")) : (ie("In page link (#" + n + ") not found in iFrame, so sending to parent"),
                Ne(0, 0, "inPageLink", "#" + n))
            }
            function e() {
            ...
            function o() {
                ...
                setTimeout(e, m)) : re("In page linking not fully supported in this browser! (See README.md for IE8 workaround)")
            }
    ...
    function le(e, t, n, o) {
        return t !== e && (e in n || (re(e + " is not a valid option for " + o + "CalculationMethod."),
        e = t),
    ...
    function he() {
        ...
        !0 === i ? (de("add"),
        e = b < 0,
        window.MutationObserver || window.WebKitMutationObserver ? e ? ge() : s = function() {
            function t(e) {
                function t(e) {
                    !1 === e.complete && (ie("Attach listeners to " + e.src),
            ...
            return {
                disconnect: function() {
                    "disconnect"in s && (ie("Disconnect body MutationObserver"),
                    s.disconnect(),
                    u.forEach(o))
                }
            }
        }() : (ie("MutationObserver not supported in this browser!"),
        ge())) : ie("Auto Resize disabled")
    }
    function ge() {
        0 !== b && (ie("setInterval: " + b + "ms"),
    ...
    function Se() {
        x || (x = !0,
        ie("Trigger event lock on")),
        clearTimeout(e),
        e = setTimeout(function() {
            x = !1,
            ie("Trigger event lock off"),
            ie("--")
        }, m)
    }
    function Me(e) {
    ...
    function Ne(e, t, n, o, i) {
        var r;
        !0 === C && (c === i ? i = k : ie("Message targetOrigin: " + i),
